...
class Transformer(Module):
    ...
    def forward(self, src: Tensor, tgt: Tensor, src_mask: Optional[Tensor] = None, tgt_mask: Optional[Tensor] = None,
                ...
                img_encoding: Optional[Tensor] = None) -> Tensor:
        ...
        Args:
            ...
            img_encoding: representation of the input image (optional)
        ...
        memory = self.encoder(src, mask=src_mask, src_key_padding_mask=src_key_padding_mask, img_encoding=img_encoding)
